...
//   if(gameOver == true){return;}
            ...
            // /===== Ball returns when strikes the bat
            if (Ball.intersects(Bat)) {
                movey = -movey;
                // if(Ball.y + Ball.width >=Bat.y)
            }
            // //=====================================
            // ....ball returns when touches left and right boundary
   ...
   //System.out.print("game");
    ...
    public void initializeVariables(){
        ...
        // Rectangle Brick;// = new Rectangle(brick x, brick y, 30, 10);
